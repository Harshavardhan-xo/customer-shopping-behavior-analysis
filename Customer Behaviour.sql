...
-- Q5. Do subscribe customer spend more? compare average spend and total revenue between subscribe
-- and non subscribes ?
...
-- Q9. Are customers who are repate buyers (more than 5 previous purchases) also likely to subscribe ?

select subscription_status,count(customer_id) as repate_buyers
from customer
